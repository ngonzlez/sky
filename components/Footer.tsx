          ...
          <div>
            ...
            <ul className="flex flex-col gap-3">
              <li className="flex items-start gap-2 text-sm text-white/60">
                ...
                <span>Edificio Sky Center, Avda. San Martín y Austria – Piso 7, Oficina 701</span>
              </li>
              ...
              <li className="flex items-center gap-2 text-sm text-white/60">
                ...
                <a href="https://www.instagram.com/skyclinicametabolica/" target="_blank" rel="noopener noreferrer"
                  className="hover:text-white transition-colors">
                  @skyclinicametabolica
                </a>
              </li>
            </ul>
          </div>
